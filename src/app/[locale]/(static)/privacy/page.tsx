...
const Privacy = () => {
  return (
    <main className="flex flex-col gap-4 px-8 py-4">
      ...
      />
      <h4 className="text-lg font-bold">Terms Of Use And Privacy Policy</h4>
      <p>Last updated: Nov 15, 2023</p>
      <p>
      ...
      <h4 className="text-xl font-bold">Interpretation and Definitions</h4>
      <p>
      ...
      <h4 className="text-xl font-bold">Definitions</h4>
      ...
      <ul className="ml-6 flex list-disc flex-col gap-4">
        ...
        <li>
          <span className="font-bold">Application </span> refers to Ayyam LLC,
          the software program provided by the Company.
        </li>
        <li>
          <span className="font-bold">Company </span> (referred to as either
          {/*eslint-disable-next-line react/no-unescaped-entities */}
          "the Company", "We", "Us" or "Our" in this Agreement) refers to Ayyam
          LLC.
        </li>
        <li>
        ...
        <li>
          <span className="font-bold">Service </span> refers to the Ayyam APP
          And Website.
        </li>
        <li>
      ...
      <h5 className="text-lg font-bold">Types of Data Collected</h5>
      ...
      <h6 className=" font-bold">Use of Your Personal Data</h6>
      ...
      <ul className="ml-6 flex list-disc flex-col gap-4">
        ...
        <li>
          <span className="font-bold">To manage Your requests</span> To attend
          and manage Your requests to Us.
        </li>
        <li>
          <span className="font-bold">For business transfers</span> We may use
        ...
        <li>
          <span className="font-bold">For other purposes</span> We may use Your
      ...
      <ul className="ml-6 flex list-disc flex-col gap-4">
        <li>
          <span className="font-bold">With Service Providers</span> We may share
          Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You
        </li>
        <li>
          <span className="font-bold">For business transfers</span> We may share
          or transfer Your personal information in connection with, or during
          negotiations of, any merger, sale of Company assets, financing, or
          acquisition of all or a portion of Our business to another company.
        </li>
        <li>
          <span className="font-bold">With Affiliates</span> We may share Your
        ...
        <li>
          <span className="font-bold">With business partners</span> We may share
        ...
        <li>
          <span className="font-bold">With Your consent</span> We may disclose
          Your personal information for any other purpose with Your consent.
        </li>
      </ul>

      <h6 className=" font-bold">Retention of Your Personal Data</h6>
      <p>
      ...
      <h6 className=" font-bold">Transfer of Your Personal Data</h6>
      <p>
        {/*eslint-disable-next-line react/no-unescaped-entities */}
      ...
      <h6 className=" font-bold">Delete Your Personal Data</h6>
      <p>
      ...
      <h6 className=" font-bold">Disclosure of Your Personal Data</h6>
      <h6 className=" text-sm font-bold">Business Transactions</h6>
      <p>
      ...
      <h6 className=" text-sm font-bold">Law enforcement</h6>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h6 className=" text-sm font-bold">Other legal requirements</h6>
      <p>
      ...
      <h6 className=" font-bold">Security of Your Personal Data</h6>
      <p>
      ...
      {/*eslint-disable-next-line react/no-unescaped-entities */}
      <h6 className=" font-bold">Children's Privacy</h6>
      <p>
      ...
      <p className="hover:font-bold">
        <a href="mailto:info@ayyam.com">info@ayyam.com</a>
      </p>
      <p className="hover:font-bold">
        <a href="tel:+201097941007">+201097941007</a>
      </p>
      <p>Thank you</p>
      <p>Ayyam Team</p>
    </main>
