...
import { Data, PostContainerProps } from '@/Types';
import { options } from '@/app/api/auth/[...nextauth]/options';
...
export const PostContainer = async ({
  ...
  return (
    // lg:w-[800px]
    <div
      className={`flex min-h-[730px] w-[450px] flex-col sm:rounded-xl border shadow-lg dark:border-gray-600 text-gray-800 dark:text-white ${direction === 'horizontal' ? 'xl:h-[585px] xl:min-h-0 xl:w-[800px] xl:flex-row' : ''} `}
    >
      <div
